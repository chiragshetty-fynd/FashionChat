...
class CannyText2Image:
    def __init__(self, device):
        ...
        self.pipe = StableDiffusionControlNetPipeline.from_pretrained(
            ...
            controlnet=self.controlnet,safety_checker=StableDiffusionSafetyChecker.from_pretrained('CompVis/stable-diffusion-safety-checker'),
            torch_dtype=self.torch_dtype)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', type=str, default="ImageCaptioning_cuda:0,Text2Image_cuda:0,CannyText2Image_cuda:1")
